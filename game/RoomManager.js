...
function RoomManager(io){
    ...
    RmMg.create = function(sockets, wait_time, auction_time, waitingRoom){
        ...
        sockets.forEach(function(socket){
            socket.emit("enter-game", {wait: wait_time, auction: auction_time, lineup:room.lineup_index});
...
function Room(manager, id, sockets, wait_time, auction_time) {
    ...
    // 경매 순서
    room.lineup_index = shuffle([2, 3, 4, 5, 7, 8, 9, 10, 12, 13, 14, 15, 17, 18, 19, 20, 22, 23, 24, 25]);
